  ...
  return (
    <div className='vision-main-div' id='vision'>
        <h1 className='vision-h1'>
            ...
            <Image src='/ring.png' width={40} height={60} alt='ring' /></span><span className='text-green'>N</span>
        </h1>
        ...
        <div className='key-div'>
            <span className='key'><Image src="/key.png" width={140} height={140} alt='key' /></span>
        </div>
    </div>
  )
}
