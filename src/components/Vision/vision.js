  ...
  return (
    <div className='vision-main-div' id='vision'>
        <h1 className='vision-h1'>
            THE&nbsp;<span className='text-green'>VISI</span><span className='ring'><Image src='/ring.png' width={60} height={80} alt='ring' /></span><span className='text-green'>N</span>
        </h1>
        ...
        <div className='key-div'>
            <span className='key'><Image src="/key.png" width={150} height={150} alt='key' /></span>
        </div>
    </div>
  )
}
